...
public final class Keys {
     ...
     */
    public static final Key.KeyInteger INPUT_COUNT  // needs to have the same default value as ADDR_BITS!!!  see de.neemann.digiblock.gui.components.EditorFactory#DataFieldEditor
    ...
    public static final Key<Integer> ADDR_BITS
            = new Key.KeyBits("AddrBits", 2).setMax(24); // needs to have the same default value as INPUT_COUNT!!!  see de.neemann.digiblock.gui.components.EditorFactory#DataFieldEditor
    ...
    public static final Key<File> SETTINGS_JAR_PATH
            = new Key.KeyFile("jarPath", new File("./jarLib")).setDirectoryOnly(true).setSecondary().setRequiresRestart();
