 ...
 */
public class DigiblockUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable throwable) {
        ...
        File log = new File(home, "Digiblock_" + formatDate.format(new Date()) + ".log");
    ...
    private void writeLog(BufferedWriter w, Thread thread, Throwable throwable) throws IOException {
        w.write("This file was created because there was an unexpected exception in Digiblock.");
        w.newLine();
        w.write("Please send this file to digiblock-simulator@web.de or create an issue at");
        w.newLine();
        w.write("GitHub: https://github.com/hneemann/Digiblock/issues");
        w.newLine();
        w.newLine();
        w.write("Manifest: ");
        w.newLine();
