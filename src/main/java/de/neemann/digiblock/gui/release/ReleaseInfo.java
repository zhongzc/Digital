...
public final class ReleaseInfo {
    private static final String RELEASE_URL = "https://api.github.com/repos/hneemann/Digiblock/releases/latest";
    private static final String RELEASE_URL_NEW = "https://api.github.com/repos/hneemann/DigiblockCS/releases/latest";
    ...
    ReleaseInfo() throws IOException {
        try {
            ...
            Preferences.userRoot().node("dig").put("newname", "DigiblockCS");
        } catch (IOException e) {
